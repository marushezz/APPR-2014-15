...
Na podlagi podatkov od let 2000 do 2012 iz te tabele(prebivalstvo) in podatkov o bruto dodani vrednosti po posameznih letih v Sloveniji iz tabele DODANAVRED, sem narisala graf. \\
...
\end{center}
Model napoveduje, da bo BDP v prihodnosti še malo padal.
\begin{center}
\includegraphics[width=\textwidth]{../slike/napovedPREBIVALSTVA.pdf}
\end{center}
Iz slike je razvidno, da model napoveduje rast prebivalstva v prihodnje.
